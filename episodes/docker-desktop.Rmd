...
We can even if any of the building blocks of the image are vulnerable, and where they come from (Image hierarchy).
...
If we stop the container, we get a familiar empty tab in `Exec` and `Stats`.q
