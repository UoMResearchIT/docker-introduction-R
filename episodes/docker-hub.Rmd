...
Many of the images are curated by the developers of the software they contain.
...
## Alternatives to the Docker Hub
...
The top-right (`Docker Pull Command`) provides the command to pull this container image to your computer.
...
This can be a useful feature for understanding what is in the image and evaluating its security, but it is not always easy to interpret.

## Overview (Documentation)

The Overview tab contains the documentation of the container image.

For well maintained images, this will contain a lot of useful information.
This can include how to use the image and how to configure it.

For the SPUC image, the documentation contains a few useful pointers.
It tells us how to:

* Run the service
* Register a new unicorn sighting
...
Lets go ahead and follow these instructions to get our SPUC service configured just right.
