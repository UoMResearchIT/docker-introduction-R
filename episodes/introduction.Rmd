...
If you have been developing software for a while, you have probably come across at least some of the following phrases:

- ***"Oh you just need to..."***  
  Do a very complicated set of steps to get the software to work?!  
  Not with Docker - the recipe is built into the container!
...
In short, Docker can help us overcome some of the problems that have plagued software development for years!

### Microservices

Although something of a jargon term, microservices are a powerful and fun way to build software.

In the same way that using libraries makes your code more modular, more powerful, and easier to understand,
using microservices makes your *software stack* do more interesting things, more easily.
