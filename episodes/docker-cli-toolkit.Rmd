...
You may remember that in Docker Desktop we could explore the image composition and metadata.
We called this 'inspecting' the image and to do this in the Docker CLI, we can use:
```bash
...
One of the very useful things we could do in Docker Desktop was to run commands inside a container.
