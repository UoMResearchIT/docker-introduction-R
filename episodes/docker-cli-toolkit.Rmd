...
In this case, the `pull` command is actually a shorthand for `docker image pull`.

In this lesson, we have decided to use the most common versions of commands, often the shorthand.
